                ...
                {(!tailors || tailors.length === 0) ? (
                    <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                            There are currently no tailors with complete profiles. If you're a tailor, please complete your profile to appear here.
                        </p>
                        <div className="space-y-2 text-sm text-gray-500 dark:text-gray-400 text-left max-w-md mx-auto bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                            <p className="font-semibold">Why might this be empty?</p>
                            <ul className="list-disc list-inside space-y-1 ml-2">
                                <li>No tailor accounts have been created yet</li>
                                <li>Tailors haven't completed their profile setup</li>
                                <li>Database migrations might need to be run</li>
                            </ul>
                        </div>
                    </div>
                ) : (
                                ...
                                <div className="p-6">
                                    <Link href={`/tailors/${tailor.slug}`} className="block group">
                                        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1 group-hover:text-[var(--color-primary)] transition-colors">
                                            {tailor.business_name || tailor.profiles?.full_name}
                                        </h3>
                                    </Link>
